...
namespace ReceptionSignage
{
    public class Function
    {
        ...
        private IModelStore<ReceptionSignageInputs> store;

        public async Task<ReceptionSignageOutputs> Handler(ReceptionSignageInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<ReceptionSignageInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<ReceptionSignageInputs,ReceptionSignageOutputs>(store, ReceptionSignage.Execute);
